...
#include "polynorm_bw_fused_partials_program_factory.hpp"
...
constexpr auto kReaderKernelPath =
    ...
    "reader_polynorm_bw_fused_partials_interleaved_start_id.cpp";
constexpr auto kDLdxWriterKernelPath =
    "tt-train/sources/ttml/metal/ops/polynorm_bw/device/kernels/dataflow/"
    "writer_polynorm_bw_fused_partials_interleaved_start_id.cpp";
constexpr auto kComputeKernelPath =
    "tt-train/sources/ttml/metal/ops/polynorm_bw/device/kernels/compute/polynorm_bw_fused_partials_kernel.cpp";
...
constexpr auto kInputPass4CbIndex = tt::CBIndex::c_3;
constexpr auto kInputPass5CbIndex = tt::CBIndex::c_4;
constexpr auto kInputPass6CbIndex = tt::CBIndex::c_5;
constexpr auto kDLdoutPass1CbIndex = tt::CBIndex::c_6;
constexpr auto kDLdoutPass2CbIndex = tt::CBIndex::c_7;
constexpr auto kDLdoutPass3CbIndex = tt::CBIndex::c_8;
constexpr auto kDLdoutPass4CbIndex = tt::CBIndex::c_9;
constexpr auto kScalerCbIndex = tt::CBIndex::c_10;
constexpr auto kEpsCbIndex = tt::CBIndex::c_11;
constexpr auto kOneCbIndex = tt::CBIndex::c_12;
constexpr auto kW0CbIndex = tt::CBIndex::c_13;
constexpr auto kW1CbIndex = tt::CBIndex::c_14;
constexpr auto kW2CbIndex = tt::CBIndex::c_15;
// CBs with intermediate computations
constexpr auto kSumX2CbIndex = tt::CBIndex::c_16;
constexpr auto kSumX4CbIndex = tt::CBIndex::c_17;
constexpr auto kSumX6CbIndex = tt::CBIndex::c_18;
constexpr auto kSumScale1CbIndex = tt::CBIndex::c_19;
constexpr auto kSumScale2CbIndex = tt::CBIndex::c_20;
constexpr auto kSumScale3CbIndex = tt::CBIndex::c_21;
constexpr auto kInvRmsXCbIndex = tt::CBIndex::c_22;
constexpr auto kInvRmsX2CbIndex = tt::CBIndex::c_23;
constexpr auto kInvRmsX3CbIndex = tt::CBIndex::c_24;
constexpr auto kCoeff1CbIndex = tt::CBIndex::c_25;
constexpr auto kCoeff2CbIndex = tt::CBIndex::c_26;
constexpr auto kCoeff3CbIndex = tt::CBIndex::c_27;
// CB with output data
constexpr auto kOutputCbIndex = tt::CBIndex::c_28;
constexpr auto kPackedPartialsOutputCbIndex = tt::CBIndex::c_29;
...
PolyNormBackwardFusedPartialsProgramFactory::cached_program_t PolyNormBackwardFusedPartialsProgramFactory::create(
    ...
    [[maybe_unused]] auto cb_input_pass_4 =
        create_circular_buffer(program, all_cores, kInputPass4CbIndex, data_format, bfloat16_tile_size, block_size);
    [[maybe_unused]] auto cb_input_pass_5 =
        create_circular_buffer(program, all_cores, kInputPass5CbIndex, data_format, bfloat16_tile_size, block_size);
    [[maybe_unused]] auto cb_input_pass_6 =
        create_circular_buffer(program, all_cores, kInputPass6CbIndex, data_format, bfloat16_tile_size, block_size);
    [[maybe_unused]] auto cb_dL_dout_pass_1 =
        create_circular_buffer(program, all_cores, kDLdoutPass1CbIndex, data_format, bfloat16_tile_size, block_size);
    [[maybe_unused]] auto cb_dL_dout_pass_2 =
        create_circular_buffer(program, all_cores, kDLdoutPass2CbIndex, data_format, bfloat16_tile_size, block_size);
    [[maybe_unused]] auto cb_dL_dout_pass_3 =
        create_circular_buffer(program, all_cores, kDLdoutPass3CbIndex, data_format, bfloat16_tile_size, block_size);
    [[maybe_unused]] auto cb_dL_dout_pass_4 =
        create_circular_buffer(program, all_cores, kDLdoutPass4CbIndex, data_format, bfloat16_tile_size, block_size);
    ...
    [[maybe_unused]] auto cb_sum_scale_1 = create_circular_buffer(
        program, all_cores, kSumScale1CbIndex, tt::DataFormat::Float32, float32_tile_size, kNumOneTile);
    [[maybe_unused]] auto cb_sum_scale_2 = create_circular_buffer(
        program, all_cores, kSumScale2CbIndex, tt::DataFormat::Float32, float32_tile_size, kNumOneTile);
    [[maybe_unused]] auto cb_sum_scale_3 = create_circular_buffer(
        program, all_cores, kSumScale3CbIndex, tt::DataFormat::Float32, float32_tile_size, kNumOneTile);
    ...
    std::vector<uint32_t> compute_group_1_args = {num_rows_per_core_group_1, block_size, Wt, args.debug_stage};
    ...
    if (!core_group_2.ranges().empty()) {
        std::vector<uint32_t> compute_group_2_args = {num_rows_per_core_group_2, block_size, Wt, args.debug_stage};
...
void PolyNormBackwardFusedPartialsProgramFactory::override_runtime_arguments(
