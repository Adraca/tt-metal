...
#include "polynorm_bw_fused_partials_device_operation.hpp"
...
void PolyNormBackwardFusedPartialsDeviceOperation::validate_on_program_cache_miss(
...
spec_return_value_t PolyNormBackwardFusedPartialsDeviceOperation::compute_output_specs(
    const operation_attributes_t&, const tensor_args_t& tensor_args) {
...
tensor_return_value_t PolyNormBackwardFusedPartialsDeviceOperation::create_output_tensors(
...
ttsl::hash::hash_t PolyNormBackwardFusedPartialsDeviceOperation::compute_program_hash(
    const operation_attributes_t& args, const tensor_args_t& tensor_args) {
    const auto& input = tensor_args.input;
    return tt::tt_metal::operation::hash_operation<PolyNormBackwardFusedPartialsDeviceOperation>(
        args.epsilon, args.w0, args.w1, args.w2, args.debug_stage, input.dtype(), input.logical_shape());
}
